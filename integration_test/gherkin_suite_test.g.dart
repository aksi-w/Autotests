    ...
    runFeature(
      ...
      run: () {
        runScenario(
          ...
          description: null,
          path:
              'C:\\Users\\XE\\Desktop\\qa-school-autotests\\examples\\profile\\.\\integration_test\\features\\profile.feature',
          tags: <String>[],
          steps: [
            (
            ...
            (
              ...
              return await runStep(
                name: 'И Я выбираю город из списка',
                multiLineStrings: <String>[],
                table: null,
                dependencies: dependencies,
                skip: skip,
        ...
        runScenario(
          name: 'Неуспешное заполнение профиля данными',
          description: null,
          path:
              'C:\\Users\\XE\\Desktop\\qa-school-autotests\\examples\\profile\\.\\integration_test\\features\\profile.feature',
          tags: <String>[],
          steps: [
            ...
            (
              ...
              return await runStep(
                name: 'Тогда Я вижу ошибку в поле дня рождения',
                multiLineStrings: <String>[],
                table: null,
                dependencies: dependencies,
                skip: skip,
